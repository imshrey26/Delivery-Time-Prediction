...
from src.config.configuration import PREPROCESSING_OBJ_FILE_PATH,TRANSFORM_TRAIN_FILE_PATH,TRANSFORM_TEST_FILE_PATH,FEATURE_ENGG_OBJ_FILE_PATH
...
class DataTransformationConfig:
    processed_obj_file_path = PREPROCESSING_OBJ_FILE_PATH
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(f'Shape of training set {train_df.shape}')
            test_df = pd.read_csv(test_path)
            logging.info(f'Shape of testing set {test_df.shape}')
            ...
            processing_obj = self.get_transformation_obj()
